  ...
  <div className="flex flex-col justify-center items-center gap-12 py-24 lg:py-32">
    <TransitionWrapper>
      <h1 className="font-bold text-xl lg:text-5xl/[4rem] xl:max-w-2xl mx-auto text-center">
        Empower Your Trading Journey with SwizzFunds
      </h1>
    </TransitionWrapper>
    <TransitionWrapper>
      <p className="lg:text-xl xl:max-w-2xl text-center text-white">
        Join thousands of global traders accessing 1,000+ assets, real-time market insights, and advanced tools—all from one powerful platform. With SwizzFunds, financial freedom is just a trade away.
      </p>
    </TransitionWrapper>
    <TransitionWrapper>
      <div className="mt-8">
