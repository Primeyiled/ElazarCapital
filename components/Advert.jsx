      ...
      <div className="grid gap-6 w-full">
        <TransitionWrapper>
          <h2 className="font-bold text-3xl py-6 lg:text-5xl/[4rem]">
            Start Trading with SwizzFunds in Just a Few Steps
          </h2>
        </TransitionWrapper>
        <TransitionWrapper>
          <p className="text-[#a0cdcd] md:text-lg lg:w-[400px]">
            We’ve made it simple. From registration to withdrawal, SwizzFunds puts you in control of your financial journey — securely and efficiently.
          </p>
        </TransitionWrapper>
          ...
          <TransitionWrapper>
            <div className="flex items-start gap-6">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-[#a0cdcd] md:text-lg lg:w-[400px]">
                  Sign up in minutes and verify your email to gain instant access to global financial markets.
                </p>
              </div>
            </div>
          </TransitionWrapper>
          ...
          <TransitionWrapper>
            <div className="flex items-start gap-6">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-[#a0cdcd] md:text-lg lg:w-[400px]">
                  Choose from flexible deposit plans and payment methods tailored to your convenience.
                </p>
              </div>
            </div>
          </TransitionWrapper>
          ...
          <TransitionWrapper>
            <div className="flex items-start gap-6">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-[#a0cdcd] md:text-lg lg:w-[400px]">
                  Once your plan matures, you can withdraw funds directly to your wallet — fast and hassle-free.
                </p>
              </div>
            </div>
          </TransitionWrapper>
